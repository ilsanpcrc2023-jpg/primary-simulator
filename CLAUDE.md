...
**시뮬레이터 버전**: **v6.4.8** (INIT_B HCC 분석 신값 반영 · L 슬라이더 -50%p 확장 · F 버튼 누적 증가 · P카드 헤더 L% 동적 표시 · PT 디폴트 1천만원)
...
- 버전 태그 이력: `v5.0` · `v6.0.0` · `v6.1.0` · `v6.2.0~3` · `v6.3.0` · `v6.4.0` · `v6.4.1~2` · `v6.4.3` (디폴트 복귀 + 프리셋 2k) · `v6.4.4` (PT 1천만 + 합계확대 + L헤더) · `v6.4.5` (INIT_B HCC + L -50%p) · `v6.4.6` (F버튼 정비) · `v6.4.7` (균등/차등 누적 +1만원) · **`v6.4.8`** (P카드 헤더 동적 L% + 하단 수식 제거)
