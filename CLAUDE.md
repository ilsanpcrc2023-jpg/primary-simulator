...
**시뮬레이터 버전**: **v6.9.3** (명칭 체계 PB·PF + 정책 모드 노출 구조 + 의원 KPI "공단지급분 변화" 재정의 · v6.9.2-bidir 누적)
...
│   ├── WinWinWin.jsx
│   ├── FBalanceCorrection.jsx   # v6.9.3: PF 자동 산출 (calcPF_fromBalance·distribute·signalLevel export · alias calcF_fromBalance)
│   └── shared/NumBox.jsx
├── data/presets/
│   ├── index.js
