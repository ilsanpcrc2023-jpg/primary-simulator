...
**시뮬레이터 버전**: **v6.5.2** (합계 공식 = 절대수입+인센티브 · 1년차는 PT만 · 참고 문구 개선 · 차트를 비교 박스 뒤로)
...
2. **Shared Saving 총괄**
   - **기준 토글** (v6.5 신규): `( ) 건강보험 전체 [110.8]` / `( ) 사업대상 환자 [1.0]` · `[↩ 초기화]`
   - 초기화 = 건강보험 전체 · 110.8조원 디폴트 복귀
   - 선택된 기준이 총의료비 절감률 분모
3. **절감액 배분 비율**
