...
**시뮬레이터 버전**: **v7.8.0** (v7.5 데이터 + v7.6.x~v7.8.x 산식·UI 보완 · 최신: PF 상한 40%·C 상한 +75%p, v7.7.9 테이블 캡션 문구, v7.7.8 풋노트 미표시, v7.7.7 NT 열 미표시·엑셀 제외, v7.7.6 PF Track 배수 A 0 / B 0.5 / C 1.0)
...
| **포괄관리 지표 C (ΔC)** | **0~+75%p, step 0.5%p** (v7.8.0 · 이전 0~+25%p · 실효 상한 ≈ L1avg 74.5%p) | 0~75 | **0%p = L1 수준** (성과 0 기준점) |
