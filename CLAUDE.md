...
- 등록환자 (환자군 모형): `(PB_g + F_g) × n_reg_g` (PB_g = B × (1 − L1_g)) — **v7.6.0: M1 → PB · v7.6.1: 본인부담 항 제거**
...
② 모형 효과 = Σ n_reg_g × (ab_reg_new_g − PB_g)     (= n_reg × PF · v7.6.1: 본인부담 항 제거)
...
- Track A = PB + F (v7.6.0: FFS 기준을 M1 → PB로 대체)
