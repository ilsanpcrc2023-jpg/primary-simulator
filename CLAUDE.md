...
| LC | -30~0%p | 무제한 | -3%p |
| 의원당 실인원 | 프리셋 1,000·1,500·2,000·3,000·5,000·7,000 | ≥ 1 | **1,000** (시범사업안) |
| M (의원 수) | 프리셋 10·100·1000·3000 | ≥ 1 | **100** (시범사업안) |
...
**파일럿 데이터 전환**: 데이터 관리 카드의 "파일럿 데이터 로드" 버튼 → `loadPreset(presets[0])`로 2023 파일럿(10기관·69,604명, L·M1 실측값) 로드. F_g·regDist는 유지(정책 가정).
