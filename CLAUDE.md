...
5. 등록환자 규모 — 흰 카드 (N, M, n_reg, 요약 모두 포함)
...
**결과 영역:**
- KPI 2카드 **promoted** (의원 수입 변화 = 녹색 그라디언트 / 공단 총의료비 변화 = 파란 그라디언트)
  - `text-5xl` 퍼센트, 의원당 평균 병기 (양쪽 카드 모두)
  - 의원 수입 카드 하단에 "의원 수입 = 등록환자(환자군 모형 A + 본인부담 + R) + 비등록환자(FFS M1 유지)" 수식 설명
- 차트 2열 (환자군별 수입 / 공단 지출 비교)
...
| N (총 실인원) | 프리셋 10만·100만·1000만·5000만 | ≥ 1 | 파일럿 69,604 |
