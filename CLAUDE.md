...
**시뮬레이터 버전**: **v6.8.2** (의원 모드 보강 — 환자군 구성 프리셋 3버튼 [일반 의원·노인 집중·사용자 지정] + Win-Win-Win 직전 Track 비교 요약 3카드 신설; tracks 계산을 useSimulator 메모로 통합해 수가 탭·Track 탭 단일 소스 오브 트루스)
