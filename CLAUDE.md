...
**시뮬레이터 버전**: **v6.5.4** (디폴트=사업대상 환자 의료비 1,000억원 · Track 재원 사업대상 연동 · 사업대상 선택 시 SS 절감액 비례 축소)
...
2. **Shared Saving 총괄**
   - **기준 토글** (v6.5.4): `( ) 건강보험 전체 [110.8] 조원` / `(●) 사업대상 환자 의료비 [1,000] 억원` · `[↩ 초기화]`
   - 건강보험 전체는 조원 단위, 사업대상 환자 의료비는 **억원 단위**
   - **디폴트 · 초기화 = 사업대상 환자 의료비 1,000억원** (v6.5.4부터)
   - **사업대상 기준 선택 시 절감액이 비례 축소** (`projectScale = 사업대상/건보전체`)
     - 예: 건보 8,030억 절감 → 사업대상 1,000억 기준 ≈ 7.25억 (비율 0.000903)
