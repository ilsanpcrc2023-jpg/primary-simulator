...
export const INIT_B = [280832, 300199, 523581, 745317];
...
// v6.5.4: 디폴트를 사업대상 환자 의료비(1,000억원)로 전환. 참여의원 성과배분 재원은 이 기준으로 산정.
export const INIT_SS_COST_BASE = "project";
export const INIT_SS_PROJECT_COST = 1000;  // 억원 (사업 참여 의원 환자군 총진료비 추정 디폴트)
// 이전 명칭 유지 (하위 호환)
