...
// v7.2.0: regDist 디폴트 = 참여의원 환자분포(RD) × 1,000명 = [160, 224, 298, 318].
//   엑셀 NHIS-HCC v3.0 (2,923개 의원) RR 컬럼 정합:
//     1군 16.0% × 1,000 = 160
//     2군 22.4% × 1,000 = 224
//     3군 29.8% × 1,000 = 298
//     4군 31.8% × 1,000 = 318  (합 1,000)
//   이전 임의값 [100, 600, 200, 100] 폐기 (시범사업 임의 분배 — 데이터 근거 없음, 사용자 결정).
export const INIT_REG_DIST = [160, 224, 298, 318];
...
export const CLINIC_PRESETS = [
  { key: "general", label: "데이터 비례",  regDist: [160, 224, 298, 318] },
