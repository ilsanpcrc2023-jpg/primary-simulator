...
export const C_DELTA_MAX = 25;               // v7.8.1: 포괄관리 지표 C 슬라이더 상한 (ΔC, %p) — v7.8.0 75 → 25 복귀 (사용자 결정)
...
export const COL_ALIASES = {
  ...
  HCC: ["HCC", "A", "HCC예측", "HCC 평균", "HCC예측 평균의료비", "HCC예측\n평균의료비", "HCC예측평균의료비", "HCC 예측평균의료비", "환자군 평균\n의료비 A", "환자군 평균 의료비 A", "환자군 평균의료비", "환자군 평균의료비 A", "평균 의료비 A", "1인당 평균 의료비"],
  CR:  ["CR", "의원비중", "의원급외래 비중", "의원급외래비중", "의원급외래\n비중", "외래비중"],
  RR:  ["RR", "참여의원당 등록환자수", "참여의원당\n등록환자수", "참여의원당\r\n등록환자수\r\nRR"],
  RO:  ["RO", "등록의원외래비", "등록의원 외래비", "등록의원외래의료비"],
  // v7.7.0: 상세 편집 테이블 수기 입력 열 라운드트립 (내보내기 헤더와 동일). 정확 일치(정규화)로만 인식 — F/PF, P/PB 혼동 방지. (v7.7.7: NT 열 제외)
...
export const COL_ALIASES_EXACT_ONLY = ["C1", "COPAY"];   // v7.7.7: NT 제외 (업로드에서 읽지 않음)
